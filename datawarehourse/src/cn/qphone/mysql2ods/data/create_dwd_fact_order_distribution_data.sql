drop database if exists szbbp_dwd CASCADE;
...
CREATE TABLE szbbp_dwd.dwd_biz_trade (
  trade_id bigint     ,
  order_id bigint   ,
  user_id bigint   ,
  amount decimal(18,2)  ,
...
CREATE TABLE szbbp_dwd.dwd_cart (
  cart_id bigint     ,
  session_id string  ,
  user_id bigint   ,
  godwd_id bigint   ,
...
--尽量放到hzbap_dim库中
CREATE TABLE szbbp_dwd.dwd_code_category (
...
CREATE TABLE szbbp_dwd.dwd_order_delivery (
  order_id bigint   ,
  order_no string  ,
  consignee string  ,
  area_id bigint   ,
...
CREATE TABLE szbbp_dwd.dwd_order_item (
  user_id bigint   ,
  order_id bigint   ,
  order_no string  ,
  godwd_id bigint   ,
...
CREATE TABLE szbbp_dwd.dwd_us_order (
  order_id bigint     ,
  order_no string  ,
  order_date string  ,
  user_id bigint   ,
...
CREATE TABLE szbbp_dwd.dwd_user (
  user_id bigint     ,
  user_name string  ,
  user_gender tinyint  ,
...
CREATE TABLE szbbp_dwd.dwd_user_addr (
  user_id bigint   ,
  order_addr string  ,
...
CREATE TABLE szbbp_dwd.dwd_user_extend (
  user_id bigint   ,
  user_gender bigint   ,
...
CREATE TABLE szbbp_dwd.dwd_user_app_pv (
  log_id bigint     ,
  user_id bigint   ,
  imei string  ,
  log_time string  ,
...
CREATE TABLE szbbp_dwd.dwd_user_pc_pv (
  log_id bigint     ,
  user_id bigint   ,
  session_id string  ,
  cookie_id string  ,
